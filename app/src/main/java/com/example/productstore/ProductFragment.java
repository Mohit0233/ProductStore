...
public class ProductFragment extends Fragment implements ProductAdapter.OnItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        if (!databaseHelper.checkDataBase(requireContext())) {
            databaseHelper.addText(0, R.drawable.phone1, "Phone 1", "₹04000.00", "This is the description of the productThis is the description of the productThis is the description of the productThis is the description of the productThis is the description of the productThis is the description of the productThis is the description of the product", false, false);
